...
import cv2
import logging
from .multi_train_utils.train_eval_utils import load_model
...
class Extractor(object):
    def __init__(self, model_path, use_cuda=True):
        ...
        ###########################
        net_dict = state_dict if 'net_dict' not in state_dict else state_dict['net_dict']
        self.net = load_model(net_dict, self.net.state_dict(), self.net)
        #######################
